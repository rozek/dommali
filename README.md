...
* methods retrieving the current size and position of a DOM element have specific names (synonyms) which makes their intention more obvious particularly for casual programmers: f.e., `positionInViewport` vs. `positionInParent` vs. `positionOnPage`
